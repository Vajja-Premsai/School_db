...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['delete'])) {
    ...
    $sql = "DELETE FROM newteacher WHERE tid=?";
...
$countSql = "SELECT COUNT(*) as memberCount FROM newteacher";
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <div style="padding: 10px; margin-bottom: 10px;">
                                    <span style="margin: 0; font-size: 16px; font-weight: bold;">TOTAL TEACHER DATA-
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                        $editButton = "<a href='newteacheredit.php?tid=" . $row["tid"] . "' " .
                        "class='editBtn label bg-black' " .
                        "data-toggle='modal' " .
                        "data-target='#editNewteacherModal'>" .
                        "Edit" .
                        "</a>";

                                            $deleteButton = "<a href='newteacher.php?delete=" . $row["tid"] . "' " .
                        " class='deleteBtn'>" .
    ...
    <div class="modal fade" id="addTeckyModal" tabindex="-1" role="dialog" aria-labelledby="addTeckyModalLabel">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <?php include_once 'newteacherform.php'; ?>
            </div>
        </div>
    </div>
    <!-- Add Tecky Modal -->
    <div class="modal fade" id="editNewteacherModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <?php include_once 'newteacheredit.php'; ?>
            </div>
        </div>
    </div>
