...
<body class="hold-transition skin-green sidebar-mini">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="father_name" type="text" class="form-control"
                                        id="exampleInputPassword1" placeholder="Enter Father's Name" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="address_location" type="text" class="form-control" id="exampleInputPassword1"
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="school_name" type="text" class="form-control"
                                        id="exampleInputPassword1" placeholder="Enter School Name" required>
                                </div>
                                <div class="form-group">
    ...
    function validateForm() {
        ...
        if (!namePattern.test(name)) {
            alert("Name should contain only letters (both upper and lower case) and Space .");
            return false;
        }
        // Validating age
