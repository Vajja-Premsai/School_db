...
<body class="hold-transition skin-green sidebar-mini">
    ...
    <section class="content ">
        ...
        <div class="row">
            <div class="col-md-10  col-xs-12 col-md-offset-1 border ">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <?php
                                    ...
                                    function generateTid($conn)
                                    {
                                        ...
                                        // Debug statements
                                       // echo "Generated TID: $tid<br>";
                                    
                                        // Check if the generated TID already exists in the database
                                        $checkSql = "SELECT * FROM newteacher WHERE tid = '$tid'";
                                        $checkResult = $conn->query($checkSql);
                                    
                                        // If the TID already exists, generate a new one recursively
                                        if ($checkResult && $checkResult->num_rows > 0) {
                                            echo "TID already exists in the database. Recursively generating a new one.<br>";
                                            return generateTid($conn);
                                        }
                                    
                                        // SID is unique, return it
                                      //  echo "Generated TID is unique.<br>";
                                        return $tid;
                                    }

                                    $newTid = generateTid($conn);
                                    echo '<input name="tid" type="hidden" id="exampleInputPassword1" required value="' . $newTid . '" readonly>';
                                    ?>
                                <!-- </div> -->
                                <div class="form-group">
